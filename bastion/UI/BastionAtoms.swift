...
struct ChainBadge: View {
    ...
    private struct Meta { let name: String; let glyph: String; let color: Color }

    private var meta: Meta {
        switch chainId {
        case 1:        return Meta(name: "Ethereum",     glyph: "◆", color: Color(red: 0.384, green: 0.494, blue: 0.918))
        case 11_155_111: return Meta(name: "Sepolia",    glyph: "◆", color: Color(red: 0.654, green: 0.545, blue: 0.980))
        case 8453:     return Meta(name: "Base",         glyph: "●", color: Color(red: 0.000, green: 0.322, blue: 1.000))
        case 84_532:   return Meta(name: "Base Sepolia", glyph: "●", color: Color(red: 0.478, green: 0.651, blue: 1.000))
        case 10:       return Meta(name: "Optimism",     glyph: "○", color: Color(red: 1.000, green: 0.016, blue: 0.125))
        case 42_161:   return Meta(name: "Arbitrum",     glyph: "◇", color: Color(red: 0.157, green: 0.627, blue: 0.941))
        default:       return Meta(name: "Chain \(chainId)", glyph: "◇", color: .ink500)
        }
    }
...
struct BastionChip: View {
    enum Style { case neutral, ok, warn, bad, accent, outline }
...
enum BastionButtonStyleKind { case `default`, primary, danger, ghost }
